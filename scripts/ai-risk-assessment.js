    ...
    constructor() {
        ...
        this.models = {
            transaction_risk: {
                ...
                weights: { amount: 0.3, frequency: 0.2, sender_reputation: 0.25, receiver_risk: 0.15, time_patterns: 0.1 }
            },
            protocol_risk: {
                features: ['tvl', 'liquidity_depth', 'transaction_volume', 'error_rate', 'governance_activity'],
                thresholds: { high: 0.75, medium: 0.5 },
                weights: { tvl: 0.2, liquidity_depth: 0.25, transaction_volume: 0.2, error_rate: 0.2, governance_activity: 0.15 }
            },
            user_behavior: {
                features: ['login_frequency', 'transaction_patterns', 'asset_diversification', 'risk_tolerance', 'interaction_history'],
                thresholds: { high: 0.7, medium: 0.5 },
                weights: { login_frequency: 0.2, transaction_patterns: 0.25, asset_diversification: 0.2, risk_tolerance: 0.15, interaction_history: 0.2 }
            }
        };
    }
        ...
        const recommendations = {
            ...
            protocol: {
                ...
                low: [
                    ...
                    'Review protocol metrics weekly'
                ]
            },
            user: {
                high: [
                ...
                low: [
                    'Continue standard security measures',
                    'Provide security education resources'
                ]
            }
        };
...
if (require.main === module) {
    ...
    aiRisk.assessTransactionRisk(txData)
    ...
    aiRisk.trainModel('transaction_risk', trainingData)
