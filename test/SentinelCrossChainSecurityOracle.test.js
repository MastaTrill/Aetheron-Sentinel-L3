...
describe("SentinelCrossChainSecurityOracle", function () {
  ...
  beforeEach(async function () {
    ...
    const SentinelCrossChainSecurityOracle = await ethers.getContractFactory("SentinelCrossChainSecurityOracle");
  ...
  describe("Configuration", function () {
    ...
    it("should reject invalid trust scores", async function () {
      await expect(
        oracle.configureChainOracle(137, reporter.address, 101)
  ...
  describe("Reporting Security Data", function () {
    ...
    it("should reject reports from unauthorized addresses", async function () {
      await expect(
        oracle.connect(other).reportSecurityData(
          chainId,
          50,
          2,
          1,
