...
contract RateLimiterTest is Test {
    ...
    function testBasicRateLimit() public {
        ...
        vm.prank(user1);
        rateLimiter.withinRateLimit(500000e18, 1);
        
        // Second withdrawal - should succeed
        rateLimiter.withinRateLimit(300000e18, 1);
    ...
    function testChainSpecificLimits() public {
        ...
        vm.prank(user1);
        rateLimiter.withinRateLimit(400000e18, 100); // Should succeed
        ...
        rateLimiter.withinRateLimit(200000e18, 100);
    }
    ...
    function testWindowReset() public {
        ...
        rateLimiter.withinRateLimit(600000e18, 1);
    ...
    function testAverageWindowCalculation() public {
        ...
        vm.prank(user1);
        rateLimiter.withinRateLimit(200000e18, 1);
        ...
        rateLimiter.withinRateLimit(400000e18, 1);
        ...
        assertEq(avg, (200000e18 + 400000e18 + 300000e18) / 3);
    }
    ...
    function testRateLimitExceedance() public {
        ...
        vm.prank(user1);
        rateLimiter.withinRateLimit(900000e18, 1);
    ...
    function testZeroAmount() public {
        ...
        vm.prank(user1);
        rateLimiter.withinRateLimit(0, 1);
    ...
    function testMultipleUsers() public {
        ...
        // Check amounts are tracked separately
    ...
    function testChainLimitOverrides() public {
        ...
        // Test with chain-specific limit
        vm.prank(user1);
        rateLimiter.withinRateLimit(150000e18, 150); // Should succeed
        ...
        rateLimiter.withinRateLimit(100000e18, 150);
    }

    function testNoChainLimit() public {
        // Test without chain-specific limit
        vm.prank(user1);
        rateLimiter.withinRateLimit(500000e18, 999); // No chain limit set
