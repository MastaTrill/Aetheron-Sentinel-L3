...
export const SECURITY_MODULES: SecurityModule[] = [
  {
    ...
    description:
      'Advanced post-quantum lattice-based cryptographic coordination layer for invariant enforcement.',
    quantumLoad: 0.42,
  },
  {
    id: 'execution-vault',
...
export const STATE_MACHINE_NODES: StateMachineNode[] = [
  {
    ...
    status: 'active',
    connections: ['node-2'],
    description: 'L7 Protocol Interception',
  },
  {
    id: 'node-2',
    label: 'VERIFICATION',
    ...
    description: 'Lattice-based Validation',
  },
  {
    id: 'node-3',
    label: 'EXECUTION',
    status: 'warning',
    connections: ['node-5'],
    description: 'Atomic State Transition',
  },
  {
    id: 'node-4',
    label: 'LOCKDOWN',
  ...
  },
  {
    ...
    status: 'idle',
    connections: [],
    description: 'Finality Confirmation',
  },
];
...
export const WATCHPOINTS: Watchpoint[] = [
  ...
  {
    id: '4',
    label: 'AUCTION GHOST CHECK',
    status: 'stable',
    trend: [5, 6, 5, 7, 6, 8, 7],
  },
  {
    id: '5',
    label: 'TRADEPAIR INTEGRITY',
    status: 'stable',
    trend: [30, 32, 31, 33, 32, 34, 33],
  },
  {
    id: '6',
  ...
  {
    id: '8',
    label: 'BRIDGE ORDERING',
    status: 'stable',
    trend: [40, 42, 41, 43, 42, 44, 43],
  },
  {
    id: '9',
    label: 'MINT/BURN AUTH',
    status: 'stable',
    trend: [15, 16, 15, 17, 16, 18, 17],
  },
  {
    id: '10',
...
export const MOCK_LEAKS: DarknetLeak[] = [
  {
    ...
    source: 'OnionScan',
    leakType: 'intel',
    content: 'Targeted DDoS planning detected in Sector 7',
    riskScore: 0.82,
  },
  {
    id: 'l-2',
    ...
    content: 'Potential operator credential dump on BreachForums',
    riskScore: 0.95,
  },
];
