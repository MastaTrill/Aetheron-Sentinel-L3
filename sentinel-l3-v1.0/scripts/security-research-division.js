...
`;
  ...
  getResearchStats() {
    const stats = {
      threatIntelligence: fs.readdirSync(path.join(this.researchPath, 'threat-intelligence'))
        .length,
      vulnerabilityReports: fs.readdirSync(path.join(this.researchPath, 'vulnerability-reports'))
        .length,
