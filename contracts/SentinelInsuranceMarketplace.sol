...
contract SentinelInsuranceMarketplace is Ownable, ReentrancyGuard {
    ...
    constructor(address _paymentToken, address _insurancePool) {
    ...
    function removeLiquidity(uint256 amount) external nonReentrant {
        ...
        require(liquidityPool.totalLiquidity - liquidityPool.utilizedLiquidity >= amount, "Insufficient available liquidity");
     ...
     */
    function _calculateProviderRating(address provider) internal pure returns (uint256) {
