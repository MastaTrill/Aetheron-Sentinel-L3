...
contract SentinelCompoundMonitor is Ownable, ReentrancyGuard {
    ...
    function _checkLiquidationRisk(address user) internal {
        (uint256 collateralValue, uint256 debtValue, uint256 healthFactor) =
     ...
     */
    function _isFlashLoanPattern(address user, uint256 amount) internal view returns (bool) {
