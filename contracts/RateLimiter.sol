...
contract RateLimiter is Ownable, AccessControl, Pausable {
    ...
    event WithdrawalProcessed(address indexed user, uint256 amount, uint256 chainId, uint256 timestamp);
    ...
    function processWithdrawal(
        ...
        uint256 resetPeriod = chainResetPeriods[chainId] > 0 ? chainResetPeriods[chainId] : DEFAULT_RESET_PERIOD;
        ...
        require(currentUsage[chainId] + amount <= chainLimits[chainId], "Rate limit exceeded");
