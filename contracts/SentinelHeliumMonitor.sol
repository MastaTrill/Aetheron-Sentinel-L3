...
contract SentinelHeliumMonitor is Ownable {
    ...
    function getNetworkHealth()
        external
        view
        returns (uint256 totalDevices, uint256 activeDevices, uint256 averageLatency, uint256 networkUptime)
    {
        return (
            networkHealth.totalDevices,
            networkHealth.activeDevices,
    ...
    function _updateNetworkHealth() internal {
        ...
        emit NetworkHealthUpdate(networkHealth.totalDevices, networkHealth.activeDevices, networkHealth.networkUptime);
    }
}
