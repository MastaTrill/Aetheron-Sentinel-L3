...
async function main() {
  ...
  console.log(
    `SentinelCoreLoop deployed to: ${sentinelCoreLoopAddress} (Tx: ${sentinelCoreLoopReceipt.hash})`
  );
  ...
  console.log(
    `AetheronBridge deployed to: ${aetheronBridgeAddress} (Tx: ${aetheronBridgeReceipt.hash})`
  );
  ...
  const log = registerReceipt.logs.find(
  ...
  const multiSigAddress = '0x15b9F8ecedafD69Eb1dD93E51fE522690Bf6B7C2';
