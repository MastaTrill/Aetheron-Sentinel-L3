...
encodeFunctionData(functionFragment: 'scheduleCriticalOperation', values: [AddressLike, BigNumberish, BytesLike, BytesLike, BytesLike, BigNumberish]): string;
...
decodeFunctionResult(functionFragment: 'scheduleCriticalOperation', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'updateDelay', data: BytesLike): Result;
  ...
  export interface SentinelTimelock extends BaseContract {
    
    connect(runner?: ContractRunner | null): SentinelTimelock;
    waitForDeployment(): Promise<this>;

    interface: SentinelTimelockInterface;
...
getFunction(nameOrSignature: 'scheduleBatch'): TypedContractMethod<
      ...
      'nonpayable'
    >;
getFunction(nameOrSignature: 'scheduleCriticalOperation'): TypedContractMethod<
      [target: AddressLike, value: BigNumberish, data: BytesLike, predecessor: BytesLike, salt: BytesLike, delay: BigNumberish, ],
      [void],
      'nonpayable'
    >;
