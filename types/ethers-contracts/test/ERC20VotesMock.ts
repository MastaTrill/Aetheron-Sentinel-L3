...
export declare namespace ERC20Votes {
  ...
  export interface ERC20VotesMockInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'transferFrom', data: BytesLike): Result;
    ...
    export namespace DelegateVotesChangedEvent {
      ...
      export interface OutputObject {delegate: string, previousBalance: bigint, newBalance: bigint };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
  ...
  export interface ERC20VotesMock extends BaseContract {
    ...
    connect(runner?: ContractRunner | null): ERC20VotesMock;
