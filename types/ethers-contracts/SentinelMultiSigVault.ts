...
export interface SentinelMultiSigVaultInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: 'getConfirmation',
    values: [BigNumberish, AddressLike]
  ): string;
...
export interface SentinelMultiSigVault extends BaseContract {
  ...
  TX_EXPIRY: TypedContractMethod<[], [bigint], 'view'>;

  activateEmergencyMode: TypedContractMethod<[], [void], 'nonpayable'>;

  activeGuardians: TypedContractMethod<[], [bigint], 'view'>;
  ...
  confirmations: TypedContractMethod<[arg0: BigNumberish, arg1: AddressLike], [boolean], 'view'>;

  emergencyMode: TypedContractMethod<[], [boolean], 'view'>;

  emergencyThreshold: TypedContractMethod<[], [bigint], 'view'>;

  emergencyVoteCount: TypedContractMethod<[], [bigint], 'view'>;

  executeTransaction: TypedContractMethod<[txId: BigNumberish], [void], 'nonpayable'>;
  ...
  guardianList: TypedContractMethod<[arg0: BigNumberish], [string], 'view'>;
  ...
  requiredConfirmations: TypedContractMethod<[arg0: BigNumberish], [bigint], 'view'>;
  ...
  getFunction(nameOrSignature: 'SIGNATURE_VALIDITY'): TypedContractMethod<[], [bigint], 'view'>;
  getFunction(nameOrSignature: 'TX_EXPIRY'): TypedContractMethod<[], [bigint], 'view'>;
  getFunction(
    nameOrSignature: 'activateEmergencyMode'
  ): TypedContractMethod<[], [void], 'nonpayable'>;
  getFunction(nameOrSignature: 'activeGuardians'): TypedContractMethod<[], [bigint], 'view'>;
  getFunction(
  ...
  ): TypedContractMethod<[txId: BigNumberish, signature: BytesLike], [void], 'nonpayable'>;
  getFunction(
  ...
  getFunction(nameOrSignature: 'emergencyThreshold'): TypedContractMethod<[], [bigint], 'view'>;
  getFunction(nameOrSignature: 'emergencyVoteCount'): TypedContractMethod<[], [bigint], 'view'>;
  getFunction(
  ...
  filters: {
    ...
    'GuardianAdded(address,uint8)': TypedContractEvent<
      GuardianAddedEvent.InputTuple,
      GuardianAddedEvent.OutputTuple,
      GuardianAddedEvent.OutputObject
    >;
    ...
    'SecurityLevelChanged(uint8,uint256)': TypedContractEvent<
      SecurityLevelChangedEvent.InputTuple,
      SecurityLevelChangedEvent.OutputTuple,
      SecurityLevelChangedEvent.OutputObject
    >;
    ...
    'TransactionSubmitted(uint256,address,uint8)': TypedContractEvent<
      TransactionSubmittedEvent.InputTuple,
      TransactionSubmittedEvent.OutputTuple,
      TransactionSubmittedEvent.OutputObject
    >;
